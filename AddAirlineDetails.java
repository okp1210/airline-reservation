 ...
 * 
 */
public class AddAirlineDetails extends javax.swing.JInternalFrame {

    /**
     * Creates new form AddAirlineDetails
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Airline Details");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("Airline No");
        ...
        getAccessibleContext().setAccessibleName("Airline Details");
 ...
 public void clearFieldValue()
 {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      // String airlinenoD=airline_noTF.getText();
       String airlineMoveD=(String)moveCB.getSelectedItem();
      // String airlinesourceD=airline_sourceTF.getText();
       
       String airlinedestD=bus_destTF.getText();
       ...
       String seatD=seatTF.getText();
        ...
        try
        {
           ...
           String airlinenoD = null;
            String selectQuery = "select * from airline_details where airline_no='"+airlinenoD+"'";
            
            ResultSet rs=stat.executeQuery(selectQuery);
         
           if(rs.next()==true)
           {
             infoMessage("Already Airline Details is Added", "Create Fresh Entry !!");
             clearFieldValue();
           }
           else
           {
                 String departDate = null;
                 String airlinesourceD = null;
          String insertQuery = "insert into airline_details values(null'" + airlinenoD + "','" + airlinesourceD + "','" + airlinedestD + "','" + departDate + "','" + departTimeD + "','" + priceD + "','" + seatD + "')";
           
          stat.executeUpdate(insertQuery);
          infoMessage("plane details added Added", "Great work !!");
          clearFieldValue();
